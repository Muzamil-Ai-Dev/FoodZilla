...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-gray-950 transition-colors">
      ...
      <section className="py-24 bg-white dark:bg-gray-900 overflow-hidden transition-colors">
        <Container>
          <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
            <div className="flex-1 space-y-8 order-2 lg:order-1">
              <FadeIn>
                <h2 className="text-4xl md:text-6xl font-black text-brand-dark dark:text-white tracking-tighter italic uppercase leading-none">
            ...
            <div className="flex-1 relative w-full h-[400px] md:h-[600px] order-1 lg:order-2">
               <FadeIn delay={0.2} className="h-full">
                 <div className="relative w-full h-full rounded-[4rem] overflow-hidden shadow-2xl border-4 border-gray-100 dark:border-gray-800 group">
                    <Image 
      ...
      <section className="py-24 bg-gray-50 dark:bg-gray-950 transition-colors">
        <Container>
           <FadeIn>
             <h2 className="text-4xl md:text-5xl font-black text-brand-dark dark:text-white mb-16 italic uppercase tracking-tighter text-center">
      ...
      <div className="bg-brand-primary/5 dark:bg-brand-primary/10 transition-colors">
        <DownloadAppBanner />
      </div>

      {/* 6. Final SEO Text Section (Like foodpanda footer content) */}
      <section className="py-24 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 transition-colors">
        <Container>
           <FadeIn>
              <div className="prose prose-lg max-w-none text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                 <h2 className="text-3xl md:text-4xl font-black text-brand-dark dark:text-white mb-10 uppercase italic tracking-tight">Order food and more online from the best restaurants and shops on FoodZilla</h2>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-16">
                    <div className="space-y-4">
                       <h3 className="text-2xl font-black text-brand-dark dark:text-white uppercase italic flex items-center gap-3">
